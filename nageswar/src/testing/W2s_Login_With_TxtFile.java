...
public class W2s_Login_With_TxtFile {
	...
	public static void main(String[] args)throws Exception {
		...
		while((l=br.readLine())!=null)
		{
			...
			try
			{
				...
				else if(p[1].equalsIgnoreCase("invalid") && driver.findElement(By.xpath("(//*[contains(text(),'register with us')])[1]")).isDisplayed())
				{
					et.log(LogStatus.PASS,"Invalid mobile number");
				}
				else if(p[1].equalsIgnoreCase("valid") && p[3].equalsIgnoreCase("invalid") && driver.findElement(By.xpath("(//*[contains(text(),'Incorrect number or password!')])[1]")).isDisplayed())
				{
